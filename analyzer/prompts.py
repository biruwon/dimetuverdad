...
general: Contenido NO POLÍTICO o temas cotidianos no relacionados con política, ideología, o asuntos sociales controvertidos"""
        ...
        key_rules = """⚠️ PRIORIDAD DE CLASIFICACIÓN - REGLAS CRÍTICAS:
• hate_speech: SIEMPRE TIENE PRIORIDAD cuando hay menciones directas a individuos específicos (@usuario) combinadas con expresiones que podrían interpretarse como sexuales, degradantes o humillantes - incluso expresiones coloquiales o aparentemente "inofensivas" pueden constituir acoso sexual si buscan ridiculizar o sugerir sumisión | anti_government: CRÍTICA SISTEMA ("el gobierno es corrupto")
• hate_speech: INSULTO PERSONAL, ACOSO SEXUAL, OBJECTIFICACIÓN SEXUAL, insinuaciones sexuales degradantes, expresiones coloquiales con connotaciones sexuales que buscan humillar o sugerir sumisión sexual cuando se dirigen a individuos específicos ("X es un traidor/rata", apodos despectivos relacionados con apariencia física, insinuaciones sexuales humillantes, referencias a servicios sexuales, lenguaje que implica actos sexuales degradantes) | anti_government: CRÍTICA SISTEMA ("el gobierno es corrupto")
