...
async def analyze_tweet_multi_model(
    ...
    """
    Analyze a single tweet with multiple models for comparison.
    ...
    if verbose:
        print(f"🔍 Analyzing tweet {tweet_id} with {len(models)} models")
        if media_urls:
...
async def analyze_tweets_multi_model_cli(
    ...
    Args:
        ...
        models: List of models to use for comparison
        verbose: Enable verbose output
    ...
    if models is None:
        models = ["gemma3:27b-it-q4_K_M", "gpt-oss:20b"]  # Default models
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Analyze tweets using multiple models for comparison",
        formatter_class=argparse.RawDescriptionHelpFormatter,
        epilog="""
Examples:
  python scripts/analyze_multi_model.py                           # Analyze all unanalyzed tweets with default models
  python scripts/analyze_multi_model.py --username Santi_ABASCAL  # Analyze specific user with default models
  ...
  python scripts/analyze_multi_model.py -v                        # Verbose output with per-model details
    ...
    parser.add_argument('--models', '-m', default='gemma3:27b-it-q4_K_M,gpt-oss:20b',
                       help='Comma-separated list of models to use (default: gemma3:27b-it-q4_K_M,gpt-oss:20b)')
